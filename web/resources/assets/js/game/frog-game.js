var game = new Phaser.Game(3000, 600, Phaser.AUTO, 'mygame', { preload: preload, create: create, update: update });
            ...
            function preload() {
                ...
                game.load.image('sky', './resources/assets/images/assets/sky.jpg');
                game.load.image('ground', './resources/assets/images/assets/platform.png');
                game.load.image('star', './resources/assets/images/assets/star.png');
                game.load.image('frog', './resources/assets/images/assets/frog4.png');
                game.load.spritesheet('dude', './resources/assets/images/assets/dude.png', 32, 48);

                game.load.audio('sound1', './resources/assets/audio/frog-sound2.mp3');
